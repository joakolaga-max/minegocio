...
function App() {
    const { data, setData, loaded, syncing } = useAppData();
    ...
    return (React.createElement("div", { style: { minHeight: '100vh', background: '#0d1117', color: '#f1f5f9', fontFamily: "'Space Grotesk', system-ui, sans-serif" } },
        ...
        React.createElement("div", { style: { paddingTop: 60, paddingBottom: 80, maxWidth: 640, margin: '0 auto', padding: '76px 12px 80px' } }, !loaded ? (React.createElement("div", { style: { textAlign: 'center', padding: '80px 20px', color: '#6b7280' } },
            React.createElement("div", { style: { fontSize: 40, marginBottom: 16 } }, "\u26A1"),
            React.createElement("div", null, "Cargando..."))) : (React.createElement(React.Fragment, null,
            tab === 'calc' && React.createElement(TabCalculadora, { data: data, setData: setData, showToast: showToast }),
            tab !== 'calc' && (React.createElement("div", { className: "card", style: { textAlign: 'center', padding: '60px 20px', color: '#6b7280' } },
                React.createElement("div", { style: { fontSize: 40, marginBottom: 16 } }, "\uD83D\uDEA7"),
                React.createElement("div", { style: { fontSize: 16, fontWeight: 600, marginBottom: 8, color: '#f1f5f9' } }, "En construcci\u00F3n"),
                React.createElement("div", { style: { fontSize: 14 } }, "Esta pesta\u00F1a est\u00E1 siendo migrada")))))),
        React.createElement("div", { style: {
        ...
        menuOpen && (React.createElement(React.Fragment, null,
            ...
            React.createElement("div", { style: {
                ...
                NAV_ITEMS.map(item => (React.createElement("button", { key: item.id, onClick: () => switchTab(item.id), style: {
                    ...
                    item.label,
                    tab === item.id && React.createElement("div", { style: { marginLeft: 'auto', color: '#6366f1' } }, "\u2713"))))))),
